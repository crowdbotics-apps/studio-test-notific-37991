...
## Project Structure
    ...
    ├── studio_test_notific_37991  # Django project configurations
...
1. Clone this repo and `cd studio_test_notific_37991`
...
2. Clone this repo and `cd studio_test_notific_37991`
